...
<head>
    ...
    <link rel="stylesheet" href="statics/PageStyle/receiveEnvelop_style.css">
    ...
    <div class="rightPart">
        <div class="envelopNav">
            <ul class="nav nav-pills">
                <li role="presentation" class="active"><a href="envelope/findReEnvelope">我收到的信</a></li>
                <li role="presentation"><a href="envelope/findSeEnvelope">我发送的信</a></li>
       ...
       <div class="desEnvelop">
           ...
           <div class="envelop" v-for="(it,index) in envelopData" :class="color[index%4]">
               <span class="temple">
                   寄件人：<span class="author">{{it.author}}</span>
...
<script>
    new Vue({
        ...
        methods:{
            ...
            ChangeEnvelopId(i){
                this.envelopID=i;
                <%--this.envelopData[i].value="${pb.get(i).content}";--%>
                // Vue.set(this.envelopData,i,{
                //     author:this.envelopData.author,
                //     receiveTime:this.envelopData.receiveTime,
                //     value:this.envelopData.value,
                // })
                // alert(this.envelopData.value)
            }
        }
    })
</script>
