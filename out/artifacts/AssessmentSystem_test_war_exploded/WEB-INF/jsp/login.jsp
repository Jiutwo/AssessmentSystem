...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/statics/PageStyle/login_style.css">
    <script src="${pageContext.request.contextPath}/statics/JavaScript/axios.min.js"></script>
    <script src="${pageContext.request.contextPath}/statics/JavaScript/vue.js"></script>
    <!-- 引入样式 -->
...
<!--登录页-->
        <div class="loginPage">
            ...
            <input type="text" class="username" name="sno" v-model="sno" @keyup="judgeLogin();Login()">
            <div class="usernameTip" v-text="snoTip" :style="{color: snoTipColor}"></div>
                <span class="pwd-icon">&#xe657;</span>
            <input type="password" class="password " name="password" v-model="password" @keyup="Login">
            <div class="passwordTip"></div>
            <button type="submit" class="loginBtn" :class="loginDisable" @click="loginUser()">登录</button>
            </form>
...
<!--完善信息页-->
    ...
    <script src="${pageContext.request.contextPath}/statics/JavaScript/LoginJS.js"></script>
